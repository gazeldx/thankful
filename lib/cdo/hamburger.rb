...
class Hamburger
  ...
  def self.get_header_contents(options)
    ...
    about_intl = [
      ...
      {title: 'A', url: CDO.studio_url("/s/coursea-2019"), id: "header-course-a"},
      {title: 'B', url: CDO.studio_url("/s/courseb-2019"), id: "header-course-b"},
      {title: 'C', url: CDO.studio_url("/s/coursec-2019"), id: "header-course-c"},
      {title: 'D', url: CDO.studio_url("/s/coursed-2019"), id: "header-course-d"},
      {title: 'E', url: CDO.studio_url("/s/coursee-2019"), id: "header-course-e"},
      {title: 'F', url: CDO.studio_url("/s/coursef-2019"), id: "header-course-f"},
    ]
